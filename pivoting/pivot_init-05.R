...
### constants
###
l.spat.res <- c(paste0("g",1:6),"p1","p2","pp","px") #levels of d.spat.res 
l2.spat.res <- c(g1= "~1 m",
                 g2= "~10 m",
                 g3= "~100 m",
                 g4= "~1 km",
                 g5= "~10 km",
...
lkp.et.eu <- read_csv2(show_col_types=F, 
  "et; et2; et6;    et_label
    a;  ur; urban;  Settlements and other artificial areas
    b;  cr; crop;   Croplands
    c;  gr; grass;  Grasslands
    e;  fo; forest; Forests and woodlands
    f;  sh; shrub;  Heathland and shrub
    g;  sv; SVL;    Sparsely vegetated ecosystems
    h;  iw; wet;    Inland wetlands
    j;  rc; river;  Rivers and Canals
    k;  lr; lake;   Lakes and reservoirs
    i;  co; coas.t; Coastal beaches, dunes and wetlands
    l;  tw; coas.w; Marine inlets and transitional waters
    m;  ma; marine; Marine ecosystems")

# dat1$ect.p %>% unique %>% sort %>% dput
l.ect <- c("A1", "A2", "B1a", "B1b", "B2", "B3", "C1", "xx") #without the "X"
